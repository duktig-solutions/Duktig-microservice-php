...
class Validator {
    ...
    public static function validateRule($value, string $rule, ?bool $isset = true) : string {
        ...
        # !empty
        # Check if rule has an !empty (Not set or Not empty) flag.
        $allowEmpty = true;
        ...
        switch($ruleName) {
            ...
            case 'url':
                ...
                if(!Valid::url($value, $flag) and $required) {
     ...
     * @return array
     */
    public static function validateJson(mixed $jsonStringToValidate, array $validationRules = [], ?array $extraRules = []) : array {


        # By Default, an Errors array is empty.
        $validationErrors = [];
        ...
        foreach($validationRules as $dataName => $rulesPackage) {
            ...
            foreach($rules as $rule) {
                ...
                if(isset($dataToValidate[$dataName])) {
                    $validationResult = static::validateRule($dataToValidate[$dataName], $rule);
                } else {
     ...
     * @listening Summer 2019 before the trip to Bologna ;)
     * https://www.youtube.com/watch?v=U3SPkP4y-rY
     *
     * @listening Christmas songs Dec 2024. All is well.
     *
     * @static
     * @access private
     * @param array $dataToValidate
            ...
            foreach ($rules as $rule) {
                ...
                switch ($ruleName) {
                    ...
                    case 'at_least_one_value':
                        ...
                        # If there are no fields required to check, this will check all rules.
     ...
     * @return string
     */
    public static function validateAtLeastOneValue(mixed $values, array $itemsRequired) : string {
     ...
     * @return string
     */
    public static function validateExactKeysValues(mixed $values, array $itemsRequired) : string {
     ...
     * @return string
     */
    public static function validateNoExtraValues(mixed $values, array $itemsRequired) : string {
