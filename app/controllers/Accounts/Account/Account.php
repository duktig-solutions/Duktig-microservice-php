...
class Account {
    ...
    */
    ...
    public function deleteLoginSession(Request $request, Response $response, array $middlewareData) : bool {
        ...
        # Try to get it
        $sessionData = \Lib\Auth\TokenStorage::get($middlewareData['userRecord']['userId'], $request->paths(2));
        ...
        \Lib\Auth\TokenStorage::delete($middlewareData['account']['userId'], $request->paths(2));
